...
?>
        <form name="frm" method="post" action="" style="margin-left: 25px; margin-right: 25px; margin-bottom: 215px;">
        <h1>Product Category</h1>
        <p>
        <img src="images/add.png" alt="Add new" width="16" height="16" border="0" /> <a href="?page=add_category"> Add</a>
        </p>
        <table id="tablecategory" class="table table-striped table-bordered" cellspacing="0" width="100%"  style=" margin-bottom: 150px" >
            <thead>
                <tr>
