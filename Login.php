...
<h1 style="margin-left: 25px;" ft>Login</h1>
<form id="form1" name="form1" method="POST" action="" style="margin-left: 25px; margin-right: 25px; margin-bottom: 210px" >
<div class="row" >
    <div class="form-group" >				    
        <label for="txtUsername" class="col-sm-3 control-label">Username(*):  </label>
		<div class="col-sm-10">
		      <input  style="margin-bottom: 10px;" type="text" name="txtUsername" id="txtUsername" class="form-control" placeholder="Username" value=""/>
		</div>
      </div>  
