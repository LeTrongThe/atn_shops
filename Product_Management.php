...
<link rel="stylesheet" href="css/bootstrap.min.css">
    ...
    <script language="javascript">
        ...
        <form name="frm" method="post" action="" style="margin-left: 25px; margin-right: 25px; margin-bottom: 350px;">
    ...
    ?>
            ...
            <td align='center'><a href="Product_Management.php?function=del&&id=<?php echo $row["Product_ID"]; ?>"
